        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="card dashboard-card mx-auto" data-aos="fade-up" data-aos-duration="1000">
                    <div class="card-body">
                        <h5 class="card-title text-center mb-4">Formulir Login</h5>
                        <form id="loginForm" action="../auth/proses_login.php" method="post">
                            ...
                            <button type="submit" class="btn btn-primary w-100 shadow" data-bs-toggle="tooltip" title="Click to login to your account">
                                <i class='bx bx-log-in'></i> Login
                            </button>
                        </form>
                        <div class="mt-3 text-center">
                            <p class="mb-0">Belum punya akun? <a href="../auth/daftar.php" class="text-primary" style="text-decoration: none;" data-bs-toggle="tooltip" title="Go to sign up page">Daftar di sini</a></p>
                        </div>
                    </div>
                </div>
            </div>
